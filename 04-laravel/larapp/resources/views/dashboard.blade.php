...
<div class="menu">
    <a href="javascript:;" class="closem">
        <img src="{{ asset('images/fe--closeburger.svg') }}" alt="">
    </a>
    <nav>
...
<header class="nav level-0">
    ...
    <img src="{{ asset('images/Icon light.svg') }}" alt="Logo">
...
<section class="dashboard">
    ...
    <menu>
        <ul>
            <li>
                <a href="{{ url('users') }}">
                    <img src="{{ asset('images/Icono persona.svg') }}" alt="Users">
                    <span>Module User</span>    
                </a>
            </li>
            <li>
                <a href="{{ url('pets') }}">
                    <img src="{{ asset('images/Icono mascotas.svg') }}" alt="Pets">
                    <span>Module Pets</span>
                </a>
            </li>
            <li>
                <a href="{{ url('adoptions') }}">
                    <img src="{{ asset('images/Icono Adopciones.svg') }}" alt="Adoptions">
